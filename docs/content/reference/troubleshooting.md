...
Most of these come down to network reality or how cgvvn serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cgvvn rate-limits like any public site. cgvvn already paces
...
Where a surface is gated, cgvvn reads a cookie or token you supply
...
`cgvvn`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cgvvn actually did
